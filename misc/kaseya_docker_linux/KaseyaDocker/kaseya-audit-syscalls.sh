...
sudo ausearch --format raw -ts recent -k kcs | aureport --syscall -i --summary > $outfile-syscalls.report || true
sudo ausearch --format raw -ts recent -k kcs | aureport --file -i --summary > $outfile-files.report || true
